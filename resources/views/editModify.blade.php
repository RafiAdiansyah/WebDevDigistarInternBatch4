        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-success">
                    <form action="{{ url('/modify/update', $Modify_OLO->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="sc_number" value="{{$Modify_OLO->sc_number}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat" value="{{$Modify_OLO->alamat}}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="inputCustOlo" class="form-label">OLO Customer</label>
                                        <input type="text" name="office_name" value="{{$Modify_OLO->office_name}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="decimal" name="longitude" value="{{$Modify_OLO->longitude}}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="inputDEC" class="form-label">End Customer</label>
                                        <input type="text" name="detail_end_cust" value="{{$Modify_OLO->detail_end_cust}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="decimal" name="latitude" value="{{$Modify_OLO->latitude}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pic_office_name" value="{{$Modify_OLO->pic_office_name}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="date" name="tgl_create" value="{{$Modify_OLO->tgl_create}}"
                                                class="form-control  @error('tgl_create') is-invalid @enderror" placeholder="Enter tanggal create">
                                            @error('tgl_create')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sid" value="{{$Modify_OLO->sid}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="petugas" value="{{$Modify_OLO->petugas}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  @error('witel') is-invalid @enderror" name="witel">
                                            <option selected value="{{$Modify_OLO->witel}}">Select a Value</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  @error('status') is-invalid @enderror" name="status">
                                            <option selected value="{{$Modify_OLO->status}}">Select a Value</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="req_modify" value="{{$Modify_OLO->req_modify}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="req_bandwidth" value="{{$Modify_OLO->req_bandwidth}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="date" name="wfm_start" value="{{$Modify_OLO->wfm_start}}"
